...
INTEGRATION_DIR="${REPO_DIR}/integrations/xray_bash_onekey"
BOOTSTRAP="${INTEGRATION_DIR}/repository_files/scripts/rill_xray_agent_bootstrap.sh"
ASSET="${INTEGRATION_DIR}/assets/rill-xray-agent-xray-bundle.tar.gz"
TMP_ROOT=$(mktemp -d)
